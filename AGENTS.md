...
Key results:
- R² = 95.1% with 20 stocks
- SP-20 Mirror: CAGR 19.2%, Sharpe 0.86, Alpha +6.8%
- SP-20 Equal: CAGR 25.4%, Sharpe 1.16, Alpha +12.1%
- SP-N Alpha (retained max-Sharpe optimizer): CAGR 29.2%, Sharpe 1.17, Alpha +13.9%
...
uv run python scripts/run_alpha_backtest.py        # Walk-forward backtest for retained Alpha strategy
...
- `src/strategies/alpha.py` — SP-N Alpha strategy factory; public export uses max-Sharpe.
- `src/strategies/hedged.py` — Archived research strategy; not part of the public export.
...
**Daily update** (`.github/workflows/daily_update.yml`): Cron weekdays 22:30 UTC. Fetches fresh market data, regenerates parquet and frontend JSON, auto-commits the static export.
