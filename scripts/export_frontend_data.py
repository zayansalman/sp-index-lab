...
from src.proof.replication import tracking_frontier as tracking_frontier_fn
...
def export_variance_decomposition(
    ...
    tracking_frontier: dict | None = None,
) -> Path:
    """Generate variance_decomposition.json (mean R² by N across PIT windows).

    Args:
        rolling: DataFrame from rolling_concentration with n_stocks and r_squared.
        replication: Optional dict from rolling_replication_quality with method,
            ladder, and by_n keys.
        tracking_frontier: Optional dict from tracking_frontier with method,
            train_days, test_days, frontier, and n_fallback_windows keys.
    """
    ...
    if tracking_frontier:
        payload["tracking_frontier"] = _clean_dict(tracking_frontier)
...
def main(argv: list[str] | None = None) -> int:
    ...
    written_files.append(
        export_variance_decomposition(
            rolling,
            replication=replication,
            tracking_frontier=frontier,
        )
    )
    written_files.append(
